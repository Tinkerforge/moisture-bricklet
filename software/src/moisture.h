 ...
 *
 * moisture.h: Implementation of Moisture Bricklet messages
 *
...
#define FID_SET_MOISTURE_CALLBACK_PERIOD 2
#define FID_GET_MOISTURE_CALLBACK_PERIOD 3
#define FID_SET_MOISTURE_CALLBACK_THRESHOLD 4
#define FID_GET_MOISTURE_CALLBACK_THRESHOLD 5
#define FID_SET_DEBOUNCE_PERIOD 6
#define FID_GET_DEBOUNCE_PERIOD 7
#define FID_MOISTURE 8
#define FID_MOISTURE_REACHED 9
